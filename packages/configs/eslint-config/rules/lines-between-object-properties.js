/**
 * Rule to check empty newline between object properties
...
module.exports = {
  ...
  create(context) {
    ...
    function isPaddingBetweenTokens(first, second) {
      ...
      // the numbers of lines of comments
      let sumOfCommentLines = 0;
      // line number of the end of the previous comment
          ...
          if ((options[0] === 'always' && !skip && !isPadded) || (options[0] === 'never' && isPadded)) {
            context.report({
              ...
              fix(fixer) {
                ...
                const tokenToLineBreakAfter = tokenAfterLastToken.value === ',' ? tokenAfterLastToken : curLast;
